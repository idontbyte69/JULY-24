...
export default function Footer() {
  return (
    <footer className="bg-gray-900/95 backdrop-blur-sm border-t border-red-900/20 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">About JULY-24</h3>
            <p className="text-gray-400 text-sm">
              Supporting victims and their families through this difficult time. Together, we can make a difference.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/victims" className="text-gray-400 hover:text-red-500 text-sm">
                  Victims
                </Link>
              </li>
              <li>
                <Link href="/donate" className="text-gray-400 hover:text-red-500 text-sm">
                  Donate
                </Link>
              </li>
              <li>
                <Link href="/sign-in" className="text-gray-400 hover:text-red-500 text-sm">
                  Sign In
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/volunteer" className="text-gray-400 hover:text-red-500 text-sm">
                  Volunteer
                </Link>
              </li>
              <li>
                <Link href="/report" className="text-gray-400 hover:text-red-500 text-sm">
                  Report Information
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>Email: support@july24.org</li>
              <li>Phone: +880 1234-567890</li>
              <li>Address: Dhaka, Bangladesh</li>
              <li>Emergency: +880 1234-567891</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} JULY-24. All rights reserved.
            </p>
